...
def get_app():
    """
        ...
        Implemented June 2026 to prevent crashes in Electron distribution
    """
...
if __name__ == "__main__":
    ...
    if install_extensions:
        ...
        _log.info("="*60)
        app = get_app()
        ## TODO: currently unable to get this setup working with reload=True
        ## Previously, we used "__main__:app" instead of app. 
        ## With the new setup of lazy loading app
        uvicorn.run(app, host="127.0.0.1", port=8001, reload=False)